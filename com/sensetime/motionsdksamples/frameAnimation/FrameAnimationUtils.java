...
public class FrameAnimationUtils {
    private static final String TAG = "FrameAnimationUtils";
     ...
     */
    public FrameAnimationUtils(ImageView iv, int[] frameRes, int duration, boolean isRepeat) {
        this.mImageView = iv;
     ...
     * @param isRepeat  是否循环播放
     */
    public FrameAnimationUtils(ImageView iv, int[] frameRess, int[] durations, boolean isRepeat) {
        this.mImageView = iv;
     ...
     */
    public FrameAnimationUtils(ImageView iv, int[] frameRess, int duration, int delay) {
        this.mImageView = iv;
        this.mFrameRess = frameRess;
        this.mDuration = duration;
        this.mDelay = delay;
     ...
     * @param delay     循环播放的时间间隔
     */
    public FrameAnimationUtils(ImageView iv, int[] frameRess, int[] durations, int delay) {
        this.mImageView = iv;
        this.mFrameRess = frameRess;
        this.mDurations = durations;
        this.mDelay = delay;
